...
export default {
  ...
  props: {
    ...
    customEditorPlugins: {  // 自定义ueditor插件
      type: Array,
      default: ()=> ['addCustomizeButton.js'] // 文件名列表 如：['addCustomizeButton.js']；文件实际放置位置在ueditor文件夹下
    },
  ...
  data() {
    return {
      ...
      defaultConfig: {
        ...
        zIndex: 9,
        serverUrl: this.upload_url,//`${env.caring_api_path}file/upload`,
        toolbars: [
          [
            'anchor', // 锚点
            'undo', // 撤销
        ...
        imageUrlPrefix: this.url_prefix, /* 图片访问路径前缀 */
        ...
        scrawlUrlPrefix: this.url_prefix, /* 图片访问路径前缀 */
        scrawlInsertAlign: 'none',

        /* 截图工具上传 */
        snapscreenActionName: 'uploadimage', /* 执行上传截图的action名称 */
        snapscreenPathFormat: '/ueditor/jsp/upload/image/{yyyy}{mm}{dd}/{time}{rand:6}', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        snapscreenUrlPrefix: this.url_prefix, /* 图片访问路径前缀 */
        ...
        catcherUrlPrefix: this.url_prefix, /* 图片访问路径前缀 */
        ...
        videoUrlPrefix: this.url_prefix, /* 视频访问路径前缀 */
        ...
        fileUrlPrefix: this.url_prefix, /* 文件访问路径前缀 */
        ...
        imageManagerUrlPrefix: this.url_prefix, /* 图片访问路径前缀 */
        ...
        fileManagerUrlPrefix: this.url_prefix, /* 文件访问路径前缀 */
